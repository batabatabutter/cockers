...
public class Cook : MonoBehaviour
{
    ...
    //[SerializeField,ReadOnly, HeaderAttribute("ç°éùÇ¡ÇƒÇÈëfçﬁÇÃéÌóﬁÇ∆êîÇ")]
    ...
    void Start()
    {
        ...
        dic.Add("ÉLÉÉÉxÉc", ItemID.Cabbage);
        dic.Add("ÉjÉìÉWÉì", ItemID.Carrot);
        dic.Add("ìÿì˜", ItemID.Pork);
        dic.Add("å{ì˜", ItemID.Chicken);
        dic.Add("ãçì˜", ItemID.Beaf);
        dic.Add("ã ÇÀÇ¨", ItemID.Onion);
        dic.Add("Ç´Ç„Ç§ÇË", ItemID.Cucumber);
        dic.Add("ëÂì§", ItemID.Been);
        dic.Add("óë", ItemID.Egg);
        dic.Add("ãçì˚", ItemID.Milk);
        dic.Add("ÉWÉÉÉKÉCÉÇ", ItemID.Potato);
        dic.Add("ÉäÉìÉS", ItemID.Apple);
        dic.Add("ÉCÉ`ÉS", ItemID.Strawberry);
    ...
    //Ç«ÇÃóøóùÇÃÉ{É^ÉìÇ≈é~Ç‹Ç¡ÇΩÇ©Çí≤Ç◊ÇÈ
